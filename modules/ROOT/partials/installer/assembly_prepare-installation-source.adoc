...
[IMPORTANT]
====
Creating an installation source is required only for the Boot ISO image. Red Hat recommends the *Binary DVD* ISO image as the preferred method to install {productname}.
====
