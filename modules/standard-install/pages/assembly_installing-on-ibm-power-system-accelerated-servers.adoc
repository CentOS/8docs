...
include::ROOT:partial$installer/proc_configuring-petitboot-for-network-installation.adoc[leveloffset=+2]

include::ROOT:partial$installer/proc_configuring-petitboot-for-installation-with-usb-device-on-accelerated-servers.adoc[leveloffset=+2]
