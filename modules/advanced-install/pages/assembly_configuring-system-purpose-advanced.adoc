...
// include statement:
// include::<path>/assembly_configuring-system-purpose-advanced.adoc[leveloffset=+1]

// The following line is necessary to allow assemblies be included in other
// assemblies. It restores the `context` variable to its previous state.
:parent-context-of-configuring-system-purpose-advanced: {context}
...
[id="configuring-system-purpose-advanced_{context}"]
= Configuring System Purpose

// The `context` attribute enables module reuse. Every module's ID
// includes {context}, which ensures that the module has a unique ID even if
// it is reused multiple times in a guide.
:context: configuring-system-purpose-advanced
...
System administrators use System Purpose to record the intended use of a {productname} 8 system by the organization. When you set a system’s purpose, the entitlement server receives information that helps auto-attach a subscription that satisfies the intended use of the system. This section describes how to configure System Purpose using Kickstart.
...
include::ROOT:partial$installer/proc_configuring-system-purpose-using-kickstart.adoc[leveloffset=+1]
...
* For information about configuring System Purpose using the graphical user interface, or the `syspurpose` command-line utility, see the link:https://access.redhat.com/documentation/en-us/red_hat_enterprise_linux/8/html-single/performing_a_standard_rhel_installation/index/[_Performing a standard RHEL installation_] document.

// The following line is necessary to allow assemblies be included in other
// assemblies. It restores the `context` variable to its previous state.
:context: {parent-context-of-configuring-system-purpose-advanced}
